...
const VOCAB = {
  ...
  rail_in: ['lightning', 'on-chain', 'ecash', 'lnurl'],
  rail_out: ['m-pesa', 'mtn-momo', 'airtel-money', 'orange-money', 'bank', 'cash'],
  status: ['active', 'maintenance', 'offline'],
  kyc: ['none', 'light', 'full'],
  speed: ['seconds', 'minutes', 'hours']
};

// service_type values where rail_out (a fiat delivery rail) is required.
